    ...
    <div className="flex flex-col">
      ...
      <section className="py-stack-xl bg-white">
        <div className="max-container max-w-3xl">
          <form className="bg-brand-surface p-8 md:p-12 rounded-xl border border-brand-navy/10 shadow-sm space-y-stack-lg">
            <div className="space-y-stack-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                   ...
                   <input type="text" className="w-full bg-white border border-brand-navy/10 rounded p-3 px-4 focus:border-brand-gold outline-none transition-colors" />
                </div>
                <div className="space-y-2">
                   <label className="text-xs font-bold uppercase tracking-wider text-brand-text/60">Email Address</label>
                   <input type="email" className="w-full bg-white border border-brand-navy/10 rounded p-3 px-4 focus:border-brand-gold outline-none transition-colors" />
                </div>
              </div>
            </div>
